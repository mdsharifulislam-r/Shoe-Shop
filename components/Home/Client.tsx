  ...
  <div className="px-4 lg:px-6 lg:px-8">
    <div className="relative py-6 md:py-10 overflow-hidden  before:absolute before:top-0 before:start-0 before:z-10 before:w-20 before:h-full before:bg-gradient-to-r before:from-white before:to-transparent after:absolute after:top-0 after:end-0 after:w-20 after:h-full after:bg-gradient-to-l after:from-white after:to-transparent ereebefore:from-neutral-900 ereeafter:from-neutral-900">
      <div className="flex justify-between items-center gap-x-4">
        ...
        <svg
          className="hidden sm:block w-14 md:w-20 h-auto text-black mx-auto ereetext-white"
          xmlns="http://www.w3.org/2000/svg"
          x={0}
          y={0}
          viewBox="0 0 88 22"
        ...
        <svg
          className="hidden md:block w-14 md:w-20 h-auto text-black mx-auto ereetext-white"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 107 32"
        >
