      ...
      <div className=" col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24">
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between pb-6">
            <p className="font-normal text-lg leading-8 text-black">{cartData.length} Items</p>
            <p className="font-medium text-lg leading-8 text-black">${priceCalculate(cartData)}</p>
          </div>
          <form>
            ...
            <div className="flex items-center justify-between py-8">
              ...
              <p className="font-semibold text-xl leading-8 text-indigo-600">
                ${priceCalculate(cartData)}
              </p>
            </div>
            <Link href={'/checkout'} className="w-full flex justify-center text-center bg-indigo-600 rounded-xl py-3 px-6 font-semibold text-lg text-white transition-all duration-500 hover:bg-indigo-700">
              Checkout
            </Link>
          </form>
        </div>
